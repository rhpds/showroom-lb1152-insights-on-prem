...
These two services are not part of the Insights on premise technical preview capabilities, but they are services that are being considered for inclusion for a future release.  
...
In module 5 you installed the Insights on premise technical preview.  This is a podman container that disables some of the connectivity menu items inside of the Satellite user interface, but otherwise looks very similar to what you experienced in module 4.   The Insights analysis happens right on the Satellite and no information leaves the Satellite.   

Insights on premise is available as technical preview with the release of Satellite 6.17.
Updates to Insights on premise will be delivered in future Satellite releases - to get new Advisor recommendations or newer Insights capabilities in future releases you will need to upgrade to the latest Satellite z-stream.  

We encourage you to use Insights on premise and share your feedback with the Insights team by emailing us at insights@redhat.com.  
