...
[start=6]
6. Return to the Hybrid Cloud Console tab.  +
If you closed this, open a new tab and go to the https://console.redhat.com/insights/advisor/systems[Systems page in the advisor service^] and select `node-{guid}-1.example.com`. +
