...
Insights tells you to fix this, you need to install the tuned package then apply the tuned profile for postgresql. + 
...
Return to your Satellite UI.  
Hopefully this puts you at the Insights tab of the RHEL 9.1 host.
