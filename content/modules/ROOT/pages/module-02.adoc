...
While this is a self-managed Insights lab, that software is only a part of the overall Insights offering.  
In this module you will explore some of the other Insights capabilities which may come to Satellite in a future release.
...
Please use a web browser to navigate to the https://console.redhat.com[Hybrid Cloud Console^] at https://console.redhat.com[console.redhat.com^]. +
...
NOTE: You will see a different number and that is expected!  The next few steps will reference the number in the screenshot above, not the number that you see in your environment.
