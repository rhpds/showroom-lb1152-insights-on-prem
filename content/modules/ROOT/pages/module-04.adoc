...
NOTE: While you see results from both hosts, only work on the node1-{guid}.example.com in this module.  You  will use the node2-{guid}.example.com in the next module.
...
* Look at the recommendations column on node1-{guid}.example.com. +
...
Hopefully this puts you at the Insights tab of the node1-{guid}.example.com host.
