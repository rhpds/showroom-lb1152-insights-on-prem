...
While this is an Insights on premise lab, the Insights on premise software is only a part of the overall Insights offering.  
In this module you will explore some of the other Insights capabilities which may come to Insights on premise in a future release.
...
Please use a web browser to navigate to https://console.redhat.com[console.redhat.com]. +
...
With 37 total systems, 22 of them are conventional systems.  If you were to click Immutable there would be an additional 15 systems.
