...
* Use the same Satellite user interface as you used in module 3 to identify and resolve issues found on hosts using the Insights advisor service, without sending any data thanks to self-managed Insights capabilities with Satellite. 
...
* Self-managed Insights on Satellite (Technical preview feature).  Insights data is processed on a Satellite server.  No data is sent to Red Hat.  
