...
Please use a web browser to navigate to Satellite’s user interface at: workshop_satellite_url. +
...
Hopefully this puts you at the Insights tab of the node-{guid}-1.example.com host. +
