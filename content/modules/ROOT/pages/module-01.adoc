...
* Not using Insights.  In this state you are not using any of the services of capabilities of Insights.  Data may be still being sent to Red Hat for telemtry, subscription manager, or other similar capabilities outside of Insights.
...
In its tech preview state, only the Adviser capability of Insights will be avaialble through the Satellite user interface. 
